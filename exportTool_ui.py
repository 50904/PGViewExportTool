...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.testConnectionPushButton.setGeometry(QRect(20, 170, 81, 31))
...
"color: rgb(255, 255, 255);")
        ...
        self.exportPushButton.setGeometry(QRect(610, 200, 161, 51))
        font = QFont()
...
"color: rgb(255, 255, 255);")
        ...
        self.previewTableWidget.setGeometry(QRect(10, 340, 761, 221))
        ...
        self.objectNameComboBox.setGeometry(QRect(530, 290, 241, 24))
        ...
        self.otherSeparatorRadioButton.setGeometry(QRect(10, 120, 51, 20))
        self.separatorLineEdit = QLineEdit(self.separatorGroupBox)
        self.separatorLineEdit.setObjectName(u"separatorLineEdit")
        self.separatorLineEdit.setGeometry(QRect(80, 120, 31, 22))
        ...
        self.otherQualifierRadioButton.setGeometry(QRect(10, 120, 51, 20))
        self.qualifierLineEdit = QLineEdit(self.qualifierGroupBox)
        self.qualifierLineEdit.setObjectName(u"qualifierLineEdit")
        self.qualifierLineEdit.setGeometry(QRect(70, 120, 31, 22))
