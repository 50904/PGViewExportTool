...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def __init__(self):
        ...
        # Luodaan käyttöliittymä konvertoidun tiedoston perusteella MainWindow:n ui-ominaisuudeksi. 
        ...
        # TODO: Kun painetaan Testaa-painiketta, näytetään tilarivillä tulos ja päivitetään objektityypin valinnat. Jos virhe, näytetään msgbox
        # Painike asettaa tietokantaparametrit ja yhteysmerkkijonon

        self.ui.testConnectionPushButton.clicked.connect(self.connectDb)
        
        # TODO: Kun poistutaan objektityypin valinnasta, haetaan tyypin objektilista
        ...
        # TODO: Kun hae-painketta painetaan, päivitetään esikatselu-taulukko ja näytetään tallenna-painike
    ...
    def connectDb(self):
        ...
        self.portName = self.ui.portLineEdit.text()
        ...
        try:
            ...
            dbConnection.filterDistinctColumsFromTable(table,columns,filterText)
